...
<template>
  <div
    class="navbar-call-cta d-flex justify-content-end bg-gradient-success"
    :class="isOnFirstSlide ? '' : 'd-none'"
  >
    <a
      class="location d-md-block d-none"
      target="_blank"
