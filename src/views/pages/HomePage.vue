    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-block">
          ...
          <p class="lead">
            ...
            quality. We don’t just offer security services; we provide peace of
            mind, knowing that you’re protected by the best in the business.
          </p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-block">
          ...
          <p class="lead">
            Our approach to potential threats and our relentless pursuit of
            innovation set us apart, making us the preferred choice for those
            who value their safety and well being.
          </p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-block">
          ...
          <p class="lead">
            Emphasizes a holistic strategy in security, integrating knowledge
            and progression to meet evolving challenges.
          </p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-block">
          ...
          <p class="lead">
            Founded by Adrien and Arina, AAP Security is led by a blend of
            extensive security experience and educational insight, ensuring
            top-tier talent and innovative solutions.
          </p>
        </div>
      </div>
    </div>
